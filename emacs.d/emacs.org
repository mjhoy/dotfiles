...
Inhibit the splash screen and start up with an org mode scratch
buffer.
...
Two helm ocmmands I want to use:

=helm-show-kill-ring= and =helm-buffers-list=. Let's set key bindings.

I don't want to override similar default commands. I'll use =C-c h=
as a prefix for all helm commands.
